...
#                 indices_stayed = np.random.choice(list(range(m.out_channels)),math.floor(m.out_channels * k),replace= False)
                indices_stayed = sorted(np.random.choice(list(range(m.out_channels)),math.floor(m.out_channels * k),replace= False))
